...
bool mindHorse(string standing, string tryCover){
    ...
    standing[0] + 2 <= 8 && standing[1] - 1 >= 0 && standing[0] + 2 == tryCover[0] && standing[1] - 1 == tryCover[1] || // 2
    standing[0] + 1 <= 8 && standing[1] - 2 >= 0 && standing[0] + 1 == tryCover[0] && standing[1] - 2 == tryCover[1] || // 3
    standing[0] - 1 >= 0 && standing[1] - 2 >= 0 && standing[0] - 1 == tryCover[0] && standing[1] - 2 == tryCover[1] || // 4
    standing[0] - 2 >= 0 && standing[1] - 1 >= 0 && standing[0] - 2 == tryCover[0] && standing[1] - 1 == tryCover[1] || // 5
    standing[0] - 2 >= 0 && standing[1] + 1 <= 8 && standing[0] - 2 == tryCover[0] && standing[1] + 1 == tryCover[1] || // 6
    standing[0] - 1 >= 0 && standing[1] + 2 <= 8 && standing[0] - 1 == tryCover[0] && standing[1] + 2 == tryCover[1] || // 7
