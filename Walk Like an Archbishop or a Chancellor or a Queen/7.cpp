...
bool mindHorse(string standing, string tryCover){
    if(standing[0] + 3 <= 8 && standing[1] + 1 <= 8 && standing[0] + 3 == tryCover[0] && standing[1] + 1 == tryCover[1] || // 1
    standing[0] + 3 <= 8 && standing[1] - 1 >= 1 && standing[0] + 3 == tryCover[0] && standing[1] - 1 == tryCover[1] || // 2
    standing[0] + 1 <= 8 && standing[1] - 3 >= 1 && standing[0] + 1 == tryCover[0] && standing[1] - 3 == tryCover[1] || // 3
    standing[0] - 1 >= 1 && standing[1] - 3 >= 1 && standing[0] - 1 == tryCover[0] && standing[1] - 3 == tryCover[1] || // 4
    standing[0] - 3 >= 1 && standing[1] - 1 >= 1 && standing[0] - 3 == tryCover[0] && standing[1] - 1 == tryCover[1] || // 5
    standing[0] - 3 >= 1 && standing[1] + 1 <= 8 && standing[0] - 3 == tryCover[0] && standing[1] + 1 == tryCover[1] || // 6
    standing[0] - 1 >= 1 && standing[1] + 3 <= 8 && standing[0] - 1 == tryCover[0] && standing[1] + 3 == tryCover[1] || // 7
    standing[0] + 1 <= 8 && standing[1] + 3 <= 8 && standing[0] + 1 == tryCover[0] && standing[1] + 3 == tryCover[1] // 8
    ) {
        return true;
    }
    return false;
