    ...
    public static void meioDeUmaAventura(int N, int P, int nPocao, int[][] posicaoPotions, int[][] posicaoHouses, int posicaoAndadaX, int posicaoAndadaY, boolean[] combinacoesCertas, Set<String> coordenadasUsadas){
        if(moradorAcharPocao(nPocao, posicaoPotions, posicaoAndadaX, posicaoAndadaY)){
            ...
            if(nPocao < P && !combinacoesCertas[nPocao]){
                ...
                // System.out.println(Arrays.toString(combinacoesCertas));
                // coordenadasUsadas.remove("(" + posicaoPotions[nPocao - 1][0] + ", " + posicaoPotions[nPocao - 1][1] + ")");
                // System.out.println("Precisei voltar a remover a posicao: " + "(" + posicaoPotions[nPocao - 1][0] + ", " + posicaoPotions[nPocao - 1][1] + ")");
                // System.out.println(coordenadasUsadas);
            }
            nPocao--;
            return;
        }
        else if(!combinacoesCertas[nPocao]){
            //Andar para cima
            if(posicaoAndadaY + 1 < N && posicaoLivre(posicaoAndadaX, posicaoAndadaY + 1, coordenadasUsadas)){
                ...
                System.out.println("Na pocao: " + (nPocao + 1) + " eu tive de virar a CIMA estou na posicao: " + meiosAvancos);
            ...
            if(posicaoAndadaX - 1 >= 0 && posicaoLivre(posicaoAndadaX - 1, posicaoAndadaY, coordenadasUsadas) && !combinacoesCertas[nPocao]){
                ...
                System.out.println("Na pocao: " + (nPocao + 1) + " eu tive de virar a ESQUERDA estou na posicao: " + meiosAvancos);
            ...
            if(posicaoAndadaY - 1 >= 0 && posicaoLivre(posicaoAndadaX, posicaoAndadaY - 1, coordenadasUsadas) && !combinacoesCertas[nPocao]){
                ...
                System.out.println("Na pocao: " + (nPocao + 1) + " eu tive de virar a BAIXO estou na posicao: " + meiosAvancos);
            ...
            if(posicaoAndadaX + 1 < N && posicaoLivre(posicaoAndadaX + 1, posicaoAndadaY, coordenadasUsadas) && !combinacoesCertas[nPocao]){
                ...
                System.out.println("Na pocao: " + (nPocao + 1) + " eu tive de virar a DIREITA estou na posicao: " + meiosAvancos);
