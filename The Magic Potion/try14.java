...
public class Main {
    ...
    public static void inicioDeUmaAventura(){
        //Andar para cima
        entrePassosDeUmaAventura(posicaoHouses[nPocao][0], (posicaoHouses[nPocao][1] + 1));
        //Andar para a esquerda
        entrePassosDeUmaAventura((posicaoHouses[nPocao][0] - 1), posicaoHouses[nPocao][1]);
        //Andar para baixo
        entrePassosDeUmaAventura(posicaoHouses[nPocao][0], (posicaoHouses[nPocao][1] - 1));
    ...
    public static void entrePassosDeUmaAventura(int posicaoAndadaX, int posicaoAndadaY){
        //validar
    ...
    public static void meioDeUmaAventura(int posicaoAndadaX, int posicaoAndadaY){
        //Andar para cima
        entrePassosDeUmaAventura(posicaoAndadaX, (posicaoAndadaY + 1));
        //Andar para a esquerda
        entrePassosDeUmaAventura((posicaoAndadaX - 1), posicaoAndadaY);
        //Andar para baixo
        entrePassosDeUmaAventura(posicaoAndadaX, (posicaoAndadaY - 1));
        //Andar para a direita
        entrePassosDeUmaAventura((posicaoAndadaX + 1), posicaoAndadaY);
