...
public class try13 {
    ...
    public static boolean posicaoLivre(int nPocao, int posicaoAvaliadaX, int posicaoAvaliadaY){
        ...
        if(posicaoPotions[nPocao][0] == posicaoAvaliadaX && posicaoPotions[nPocao][1] == posicaoAvaliadaY){
            meioDeUmaAventura(nPocao, posicaoAvaliadaX, posicaoAvaliadaY);
        }
    ...
    public static void entrePassosDeUmaAventura(int nPocao, int posicaoAndadaX, int posicaoAndadaY){
        //validar
        if(!posicaoLivre(nPocao, posicaoAndadaX, posicaoAndadaY)){
            return;
        }
