...
public class Main {
    ...
    public static long craftYear(long year){
    ...
    public static int takeBiggerDigit(long year){
        while (year >= 10) {
            year /= 10;
        }
        return (int) year;
    ...
    public static int takeLength(long year){
    ...
    public static long assemblyNumber(int[] digits, long year, int length){
        ...
        for (int i = 0; i < length && !greaterFound; i++) {
            ...
            if(!digitFound){
                ...
                // 1431 -> 1432 e 1987 -> 2013
                // Check algo de valores => ver se da para aproveitar => olhar para o que falta e ver se um maior salva.
                    // Verificar se dá para aproveitar o valor
                    int valor = digits[0] + 1;
                    if(valor >= currentYearDigit){
                        return 0;
                    }
